...
class ProfileAppBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(create: (context) => GetUserCubit()..getUser(),
      child: Container(
            ...
            child: Row(
              children: [
                ...
                }, child: BlocBuilder<GetUserCubit, GetUserState>(builder: (context, state)
                {
                  if (state is GetUserSuccessState)
                    {
                      return Column(
                        children: [
                          OptionContainer(label: "Hello!", option: state.userInfo.username!)
                        ],
                      );
                    }
                  else
