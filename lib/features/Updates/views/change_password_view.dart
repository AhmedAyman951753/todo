                ...
                Builder(builder: (context) => Column(
                  children: [
                    TextContainer(
                      ...
                      textController: ChangePasswordCubit.get(context).currentPasswordController,
                  ...
                  else
                  {
                    return Column(
                      children: [
                        ...
                        MessageWithButton(message: state.msg, messageColor: AppColors.green, onPressed: (){myNavigator(context, screen: LoginView());}, buttonLabel: 'Login')
                        : state is ChangeErrorState?
                        MessageWithButton(message: state.error, messageColor: AppColors.red, onPressed: (){ChangePasswordCubit.get(context).change();}, buttonLabel: 'Update')
                        : MessageWithButton(message: '', onPressed: (){ChangePasswordCubit.get(context).change();}, buttonLabel: 'Update')
                      ],
                    );
                  }
