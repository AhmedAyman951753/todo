      ...
      body: Column(
        children: [
          ...
          Row(
            children: [
              SizedBox(width: 20),
              InkWell(onTap: (){myNavigator(context, screen: Home());},child: SvgPicture.asset(AppIcons.curvearrowbackward)),
              ProfileAppBar(),
            ],
          ),
          SizedBox(height: 40),
          SettingContainer(label: 'Update Profile', icon: AppIcons.person2, screen: UpdateProfileView()),
          SizedBox(height: 20),
          SettingContainer(label: 'Change Password', icon: AppIcons.lock, screen: ChangePasswordView()),
          SizedBox(height: 20),
          SettingContainer(label: 'Settings', icon: AppIcons.settings, screen: Settings()),
        ],
      ),
    );
  }
